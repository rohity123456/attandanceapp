    ...
    <body>
        ...
        <div class="row container">
            <div class="col-sm-12" id="top">
                 ...
                 <div id="scrollmenu">
  <a href="#home" style="padding-left: 7px; border-bottom: 5px white solid;">Subjects</a>
  <a href="admin_homepage.jsp">Teachers</a>
  <a href="admin_student.jsp">Students</a>
  ...
  <a href="#work">Work</a>
            ...
            <div class="col-sm-12" id="below">
                <div style="padding-top: 10px;" class="hove">
                    <span><a href="AddSubject.jsp"><i id="user" class="fas fa-plus-square hove"> <span style="font-size: 18px;">Add Subject</span></i></a></span>
                     
                 </div>
                <div style="margin-top: 30px;" class="hove">
                    <span ><a href="ViewSubject.jsp"><i id="view" class="fas fa-list-ol hove"> <span style="font-size: 18px; margin-left: 1px;">View Subject</span></i></a></span>
